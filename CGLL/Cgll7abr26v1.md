...
# Reunión de obra Mº Cogullada, 7 de abril de 2026
Marta [M] Aurelio [Au], Marian [Ma], Rubén [Ru], Carlos [Ca] y Alba [yo] 

M Pregunta porqué siguen apareciendo especies que se habían desestimado (chopos y pinos).

Yo Replico que, tal y como expliqué en mail, dado que se desconoce la composición y número de árboles, no se ha modificado esa parte, centrándonos en resolver la distribución de herbáceas y arbustivas.

Se simplifica el número de especies de herbáceas y arbustivas en función de la disponibilidad en viveros y se pasa revista a las especies seleccionadas y otras nuevas a considerar: retama de olor, cedro atlántico.
...
Ma Comenta que ya ha contactado con su diseñador pero nos solicitan ayuda para los textos. A su disposición.

Au se encarga de pasar a limpio listado de rastreras `entregado`
...
Ma Se encarga de pasar listado de existencias y pte. adquisición `entregado`
| Proveedor     | Especie adq.                                   | Unidades |
| ------------- | ---------------------------------------------- | -------- |
| Viveros Aznar | *Celtis australis* 10/12                       | 10       |
| Viveros Aznar | *Fraxinus angustifolia* 8/10 (Fresno) cepellón | 7        |
| Viveros Aznar | Moreras 18/20                                  | 40       |
| Viveros Aznar | Granados                                       | 5        |
|               | **Subtotal Viveros Aznar**                     | **62**   |
| Dunatino S.L. | Olmo común                                     | 5        |
| Dunatino S.L. | Aliso imperial                                 | 5        |
| Dunatino S.L. | Fresno                                         | 10       |
| Dunatino S.L. | Madroños                                       | 10       |
| Dunatino S.L. | Quejigo                                        | 10       |
|               | **Subtotal Dunatino S.L.**                     | **40**   |
|               | **TOTAL COMPRADOS**                            | **102**  |


| Especie pte.              | Nombre Común          | Notas                       |
| ---------------------------- | --------------------- | --------------------------- |
| *Juglans regia*              | Nogal                 | Pendiente                   |
| *Acer monspessulanum*        | Arce de Montpellier   | Pendiente                   |
| *Quercus pubescens*          | Roble peludo          | Pendiente                   |
| *Juniperus* / *Sabina albar* | Enebro / Sabina albar | Añadido en último informe   |
| *Quercus ilex*               | Carrasca              | Disponible en Viveros Aznar |


Se hace visita de obra y ver posición de cedros.


## INTERNO (intervalo)
M comenta la 2a parte y luego se marchará: necesita respuesta sobre la segunda parte de las acciones en la finca. 

- Equipamiento con cajas-nido, murcis, tejas-nido (primillar en torre), hoteles y demás. Esto urge con un deadline de 3 meses.
...
- El objetivo es la construcción de las charcas ya comentadas con sus sombras, sus muretes, aumentar la biodiversidad y en suma, un jardín botánico.
