# LIBRO DE ESTILO `v1 131026122025`

## ABSTRACT
A medida que se van generando informes, de forma invlountaria se cambia procedimiento. Este Libro de Estilo es un recurso, la memoria para ser más eficiente en la confección de estudios/informes/borradores de, para reaprovechar los prompts mediante forma de citarlos y estructurar planteamientos.
...
**nº | actividad | estado | días totales (en cursiva, parciales)** | Nota
1. **CEMEX** pte. inicio
...
7. Inventario pasarelas para Plan de Uso Público 25 *selecciona solo una y empezamos por ahí a registrar esta solicitud*
...
8. Monumento Natural Riglos **En ejecución** 6 *pon en el calendario la fecha del censo en mayo, igual te hacen falta dos días para que quede reflejada*
81. Censo de rupícolas en zonas de escalada (3 censos) 3
...
**nº | actividad | estado | horas/coste (€)** | Nota
14. Admin y varios 
141. LISTADO DE TAREAS 4
142. Caspe botanic 5
143. Flora invierno Ordesa 87€
144. Informe revegetación parquin [Cgll] 208€ (ver 170)
