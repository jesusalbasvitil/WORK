...
La perdiz nival (*Lagopus muta pyrenaica*) representa una subespecie endémica de los Pirineos[^1], siendo uno de los pocos galliformes adaptados a la alta montaña en la península Ibérica[^2]. Esta población constituye el límite meridional de la distribución mundial de la especie[^3].

## Características del hábitat

### Distribución altitudinal

En los Pirineos españoles, la perdiz nival ocupa principalmente el piso alpino y subnival, con presencia habitual entre los 2.000 y 2.800 metros de altitud[^4]. Durante el periodo reproductor se encuentra principalmente por encima de los 2.200 metros[^5], mientras que en invierno puede descender hasta los 1.800 metros buscando zonas con menor innivación[^6].

### Vegetación y estructura del hábitat

El hábitat característico incluye:

- Canchales y zonas de rocas fragmentadas con vegetación dispersa[^7]
- Pastizales alpinos dominados por *Festuca eskia* y *Carex curvula*[^8]
- Zonas con presencia de *Dryas octopetala* y *Salix herbacea*[^9]
- Áreas con cobertura de líquenes y musgos[^10]

### Selección estacional del hábitat

#### Periodo reproductor
- Laderas con orientación sur y sureste[^11]
- Zonas con pendientes moderadas (20-30°)[^12]
- Áreas con mosaico de vegetación y rocas[^13]

#### Periodo invernal
- Crestas y zonas venteadas con menor acumulación de nieve[^14]
- Áreas con presencia de *Rhododendron ferrugineum* para refugio[^15]

## Amenazas y conservación

Las principales amenazas documentadas incluyen:

- Cambio climático y su efecto sobre los hábitats alpinos[^16]
- Desarrollo de infraestructuras turísticas de alta montaña[^17]
- Perturbaciones por actividades recreativas invernales[^18]
- Fragmentación de poblaciones por pérdida de conectividad[^19]
