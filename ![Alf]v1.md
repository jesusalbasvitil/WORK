...
A los solos hechos reflejados en la tabla objeto de análisis, hay un claro aumento exponencial de la mortandad, *que no lo sería tanto por el incremento también exponencial de la instalación de PEs*. Sin embargo, se pueden establecer varias hipótesis previas y si son válidas, llegar a establecer conclusiones. Es el caso de determinados PEs concentren año tras año.  