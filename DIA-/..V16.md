[Statistical Weighting Methods for Biodiversity Damage Assessment. V16](https://claude.ai/chat/9eb1f659-9883-43fe-adf1-310e7197a77a)
...
→~~  **Sección relevante**: Páginas 1066-1067, "Legal Framework"; Tabla 1, comparación criterios mortalidad~~
 ...
 Michael Schaub, Spatial distribution of wind turbines is crucial for the survival of red kite populations, Biological Conservation, Volume 155, 2012, Pages 111-118, ISSN 0006-3207, https://doi.org/10.1016/j.biocon.2012.06.021.
...
→ **Datos clave**: 
  ...
  - Población Aragón 2024: ~1,500 machos territoriales
...
[²³]: **Gobierno de Aragón (2023-2024)**. Censo regional de la alondra ricotí en Aragón. Datos oficiales de censos y estimaciones poblacionales regionales  
→ **Datos censales 2017-2024**:
  - Total Aragón: 1.500 machos territoriales (tendencia -0.17% anual)
  - Zaragoza: 849 machos (56.6%, tendencia +1.78%)
  - Teruel: 637 machos (42.5%, tendencia -2.13%)
  - Huesca: 14 machos (0.9%, tendencia -2.23%)
→ **Núcleo "Parameras de Teruel"**: ~553 machos, tendencia negativa
→ **Reducción área ocupada**: De 463 cuadrículas 1×1 km (2004-2007) a 429 (2017-2024) = -7.34%
→ Fuentes: Birding Aragón, Vertebrados Ibéricos, censos autonómicos

[²⁴]: **MITECO / SEO/BirdLife (2004-2014)**. Censos nacionales de milano real (*Milvus milvus*)  
→ **II Censo Nacional (2004)**: 
  - España total invernante: 3.082 individuos
  - Teruel: 484 individuos (censo dormideros)
  - Zaragoza: 2.251-2.896 individuos estimados
  - Aragón (extrapolado): ~860 individuos (~28% nacional)
→ **III Censo Nacional (2013-2014)**: 
  - España total invernante: 50.297 individuos
  - Sin desglose provincial disponible
→ **Población reproductora Aragón (2004-2014)**: 
  - Estimado 550-650 adultos reproductores (~10-15% parejas nacionales)
→ URLs: 
  - https://www.miteco.gob.es/content/dam/miteco/es/biodiversidad/temas/inventarios-nacionales/5_milano_real_2004_tcm30-208141.pdf
  - https://seo.org/ave/milano-real/
  - https://www.life-eurokite.eu/es/live-webcams/webcam-seo-birdlife-espana.html

[²⁵]: **SEO/BirdLife (2016-2022)**. Atlas y seguimiento de ganga ortega (*Pterocles orientalis*)  
→ **III Atlas Aves Reproducción (2019-2022)**:
  - España: ~6.927 individuos (rango 3.815-11.708)
→ **Boletín SEO/BirdLife (2016)** - Seguimiento aves esteparias:
  - Aragón: 16.2% población nacional → ~1.122 individuos (618-1.896)
  - Distribución provincial Aragón:
    - Zaragoza: 50% → ~561 individuos (309-948)
    - Teruel: 38% → ~426 individuos (235-720)
    - Huesca: 12% → ~135 individuos (74-227)
→ URLs:
  - https://atlasaves.seo.org/ave/ganga-ortega/
  - https://seo.org/boletin/seguimiento/censos/54%20ganga/54%20ganga.pdf

[²⁶]: **SEO/BirdLife / MITECO**. Ficha de especie chova piquirroja (*Pyrrhocorax pyrrhocorax*)  
→ **Estado en España**: 
  - Lista Roja España: NT (Casi Amenazada)
  - Residente habitual
  - **SIN censo nacional con estimación numérica consolidada**
  - Orden de magnitud estimado: Miles a decenas de miles de individuos (no oficial)
→ **Aragón**: Presencia documentada en zonas montañosas, sin cifra oficial por CA
→ **Teruel**: Fracción considerable en Maestrazgo, Gúdar, Albarracín; sin cifra oficial
→ **III Atlas (2022)**: Distribución observada/modelizada, sin número total
→ URLs:
  - https://seo.org/ave/chova-piquirroja/
  - https://www.miteco.gob.es/content/dam/miteco/es/biodiversidad/temas/inventarios-nacionales/chova_piquirroja_tcm30-100142.pdf
  - https://atlasaves.seo.org/ave/chova-piquirroja/

[²⁷]: **SEO/BirdLife (2018)**. IV Censo Nacional de alimoche común (*Neophron percnopterus*). Del Moral, J.C. & Molina, B. (Eds.). El alimoche común en España, población reproductora en 2018 y método de censo  
→ **España (2018)**:
  - 1.490-1.567 parejas reproductoras
  - 2.980-3.134 individuos adultos reproductores
  - Mayor población detectada hasta la fecha
→ **Aragón (15.9% nacional, 2ª CA tras Castilla y León)**:
  - ~237-249 parejas reproductoras
  - ~474-498 individuos adultos reproductores
→ **Teruel (30-40% Aragón, extrapolado)**:
  - 71-100 parejas reproductoras
  - 142-200 individuos adultos reproductores
  - Hábitats relevantes: Sierras, cortados y cañones
→ **Catalogación**: Vulnerable (Catálogo Español Especies Amenazadas)
→ URLs:
  - https://www.seo.org/boletin/seguimiento/censos/51%20alimoche/pdf/SEO%2051%20Alimoche.pdf
  - https://seo.org/ave/alimoche-comun/
  - https://atlasaves.seo.org/ave/alimoche-comun/?print=pdf
  - https://seo.org/ligero-repunte-del-alimoche-comun-en-espana/
