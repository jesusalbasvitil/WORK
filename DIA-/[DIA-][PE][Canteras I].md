...
## Informe técnico de análisis ambiental y jurídico — *Parque Eólico Canteras I* (actualizado con datos sobre *Tetrax tetrax*)

### (el resto del informe previo queda igual hasta la sección de ponderación de especies)

---

## 6. Evaluación ponderada por especies (replicación metodológica revisada)

### 6.1 *Tetrax tetrax* (Sisón común)

**Distribución y contexto poblacional en Aragón**

* *Tetrax tetrax* (sisón común) ha mostrado un **declive muy marcado** en España, con reducciones de población reproductora de ~48 % entre 2005 y 2016, evidenciando una tendencia negativa en todo el territorio español. ([anuariorocin.blogspot.com][1])
* En el censo noroccidental de 2016, **Aragón contaba con ~1 804 machos reproductores estimados**, de los cuales aproximadamente **el 67 % se concentraban en la provincia de Zaragoza** (≈ 1 201 machos), evidenciando la **especial relevancia de Zaragoza para la especie**. ([anuariorocin.blogspot.com][1])

**Estado de conservación y tendencia**

* El sisón fue declarado “**Ave del año 2017**” por SEO/BirdLife, y los técnicos del Gobierno de Aragón constataron una disminución poblacional cercana al **60 %** comparando censos 2005 vs. 2016 en Aragón, una reducción que refleja una **crisis de conservación** para esta especie regional. ([heraldo.es][2])

**Hábitat y vulnerabilidad**

* Especie asociada a **zonas esteparias y campos abiertos de secano** — precisamente los tipos de hábitats donde suelen localizarse emplazamientos eólicos, lo cual aumenta la vulnerabilidad a impactos por colisión, perturbación y pérdida de hábitat. ([heraldo.es][2])

**Ponderaciones aplicadas (modelo replicado)**

| Factor                                          | Justificación                                                        | Ponderación |
| ----------------------------------------------- | -------------------------------------------------------------------- | ----------- |
| **Importancia local de población**              | Zaragoza concentra la mayoría de la población aragonesa reproductora | **3.0**     |
| **Tendencia negativa clara**                    | Reducción significativa en 10–11 años a escala nacional y regional   | **2.5**     |
| **Especialización de hábitat y vulnerabilidad** | Alta dependencia de estepas abiertas afectadas por infraestructuras  | **2.0**     |
| **Alta sensibilidad a impactos eólicos**        | Colisión, pérdida de hábitat crítico y perturbación                  | **3.0**     |
| **Total multiplicador ajustado**                | —                                                                    | **10.5**    |

**Cálculo de impacto ponderado total**

```
Impacto ponderado = (Índice base 4.0 × multiplicador 10.5)
                  = 42.0 unidades
```

➡ **Clasificación: IMPACTO CRÍTICO / Incompatible**
La cifra ponderada supera claramente los umbrales admisibles en evaluaciones de impacto ambiental rigurosas.

**Observación técnica**

* Zaragoza representa un **núcleo significativo de la distribución regional** de sisón común.
* La continua disminución poblacional reafirma la **sensibilidad y prioridad de conservación** de esta especie frente a proyectos que fragmenten hábitat o incrementen mortalidad por colisión.

---

## 7. Impactos acumulativos y conectividad

Aplicando un factor **sinérgico adicional (≥1.8)** por situación regional saturada de infraestructuras y redes eólicas, el **impacto acumulado de especies vulnerables, incluyendo *Tetrax tetrax***, se sitúa **muy por encima de umbrales compatibles** con conservación favorable.

---

## 9. Conclusión reforzada (ampliada)

La **incorporación de datos objetivos sobre *Tetrax tetrax*** —especialmente su distribución concentrada en Zaragoza y su pronunciado declive poblacional— refuerza la conclusión técnica inicial:

* El proyecto presentaría **impactos críticos para una especie clave de avifauna esteparia** que actúa como **indicador de integridad de hábitats abiertos**, con población significativa justo en el área de influencia directa del proyecto.
* Las **metodologías de ponderación actualizadas** con datos regionales no solo sugieren incompatibilidad; **consolidan un argumento cuantificable para la denegación del proyecto** con base científica.

---

## Referencias / Notas al pie (Markdown)

[¹]: “Estado actual de las poblaciones de sisón común (*Tetrax tetrax*) en Aragón. Resultados del censo de 2016,” Anuario Ornitológico de Aragón, censo SEO/BirdLife; población 2016: Aragón ~1 804 machos, Zaragoza ~1 201 machos (>60 %). ([anuariorocin.blogspot.com][1])
[²]: Declive nacional ≈48 % entre 2005 y 2016, tendencia negativa documentada en estudios de censos de sisón común en España. ([anuariorocin.blogspot.com][1])
[³]: El sisón (*Tetrax tetrax*) declarado “Ave del año 2017” en Aragón, con reducción poblacional pronunciada cercana al 60 %. ([heraldo.es][2])

---

Si quieres puedo también:

* **añadir mapa de áreas críticas** para la especie en Aragón,
* generar un **anexo de citas completas en formato jurídico**,
* o preparar una **tabla comparativa por especie y por impacto esperado**.
